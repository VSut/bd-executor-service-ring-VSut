...
public class DeviceChecker {
    ...
    public void updateDevice(final String deviceId, final RingDeviceFirmwareVersion version) {
        ...
        UpdateDeviceFirmwareRequest request = UpdateDeviceFirmwareRequest.builder().withDeviceId(deviceId).withVersion(version).build();
        UpdateDeviceFirmwareResponse response = this.ringDeviceCommunicatorService.updateDeviceFirmware(request);
    }
